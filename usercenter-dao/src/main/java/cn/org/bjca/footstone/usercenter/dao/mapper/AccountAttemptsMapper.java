...
public interface AccountAttemptsMapper {
    ...
    List<AccountAttempts> selectByExampleWithRowbounds(AccountAttemptsExample example,
        RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") AccountAttempts record,
        @Param("example") AccountAttemptsExample example);

    int updateByExample(@Param("record") AccountAttempts record,
        @Param("example") AccountAttemptsExample example);
