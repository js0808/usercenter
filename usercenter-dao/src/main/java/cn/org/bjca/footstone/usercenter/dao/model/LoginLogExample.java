...
public class LoginLogExample {
    ...
    public LoginLogExample sumId() {
        this.sumCol="id";
        return this;
    }

    public LoginLogExample sumAccountType() {
        this.sumCol="account_type";
        return this;
    }

    public LoginLogExample sumAccount() {
        this.sumCol="account";
        return this;
    }

    public LoginLogExample sumUid() {
        this.sumCol="uid";
        return this;
    }

    public LoginLogExample sumUserType() {
        this.sumCol="user_type";
        return this;
    }

  public LoginLogExample sumAppId() {
    this.sumCol = "app_id";
    return this;
  }

    public LoginLogExample sumClientInfo() {
        this.sumCol="client_info";
        return this;
    }

    public LoginLogExample sumLoginResult() {
        this.sumCol="login_result";
        return this;
    }

    public LoginLogExample sumCreateTime() {
    ...
    public LoginLogExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
