...
public class EntInfo implements Serializable {
    ...
    private String realNameIdsTransId;
    ...
    public String getRealNameIdsTransId() {
        return realNameIdsTransId;
    }

    public void setRealNameIdsTransId(String realNameIdsTransId) {
        this.realNameIdsTransId = realNameIdsTransId == null ? null : realNameIdsTransId.trim();
    }
