...
public interface UpdateInfoLogMapper {
    ...
    List<UpdateInfoLog> selectByExampleWithRowbounds(UpdateInfoLogExample example, RowBounds rowBounds);

    List<UpdateInfoLog> selectByExample(UpdateInfoLogExample example);

    UpdateInfoLog selectByPrimaryKey(Integer id);

    int updateByExampleSelective(@Param("record") UpdateInfoLog record, @Param("example") UpdateInfoLogExample example);

    int updateByExample(@Param("record") UpdateInfoLog record, @Param("example") UpdateInfoLogExample example);
