...
public interface UpdateStatusLogMapper {
    ...
    List<UpdateStatusLog> selectByExampleWithRowbounds(UpdateStatusLogExample example, RowBounds rowBounds);

    List<UpdateStatusLog> selectByExample(UpdateStatusLogExample example);

    UpdateStatusLog selectByPrimaryKey(Integer id);

    int updateByExampleSelective(@Param("record") UpdateStatusLog record, @Param("example") UpdateStatusLogExample example);

    int updateByExample(@Param("record") UpdateStatusLog record, @Param("example") UpdateStatusLogExample example);
