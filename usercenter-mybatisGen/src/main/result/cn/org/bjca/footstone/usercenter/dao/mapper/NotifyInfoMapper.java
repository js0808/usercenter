...
public interface NotifyInfoMapper {
    ...
    int updateByExampleSelective(@Param("record") NotifyInfo record, @Param("example") NotifyInfoExample example);

    int updateByExample(@Param("record") NotifyInfo record, @Param("example") NotifyInfoExample example);
