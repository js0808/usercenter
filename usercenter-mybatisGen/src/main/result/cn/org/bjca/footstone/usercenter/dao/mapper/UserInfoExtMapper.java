...
public interface UserInfoExtMapper {
    ...
    int updateByExampleSelective(@Param("record") UserInfoExt record, @Param("example") UserInfoExtExample example);

    int updateByExample(@Param("record") UserInfoExt record, @Param("example") UserInfoExtExample example);
