...
public class SignatureUtils {
    ...
    public static String signatureBean(Object bean, String signType,
        ...
        try {
            if (StringUtils.equals(signType, SIGN_ALGORITHMS_SHA256RSA)) {
                ...
                return HMAC(generateSignString(bean).getBytes(ENCODING_CHARSET_UTF8), privateKey.getBytes(ENCODING_CHARSET_UTF8), signType);
            } else {
    ...
    public static String HMAC(byte[] data, byte[] key, String signType) throws NoSuchAlgorithmException, InvalidKeyException {
    ...
    public static String signatureBean(String content, String signType, String privateKey) throws Exception {
        try {
     ...
     * @return Base64编码的签名数据
     */
    public static String signatureBean(Object bean, String signType, PrivateKey privateKey) throws Exception {
        try {
            if (StringUtils.equals(signType, ALGORITHMS_RSA)) {
                throw new Exception("不支持的签名类型参数，必须为'RSA'");
            }
     ...
     * @throws Exception
     */
    public static String generateSignString(Object bean, String publicKey, String hashType, String[] filterNames) throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        mapper.setSerializationInclusion(JsonInclude.Include.NON_EMPTY);
    ...
    public static String generateSignString(Map<String, String> props, String publicKey, String hashType, String[] filterNames) throws Exception {
     ...
     * @return 签名值
     */
    private static String sign(byte[] content, PrivateKey privateKey, String signAlg) throws Exception {
     ...
     * @return 签名值
     */
    public static String sign(String content, PrivateKey privateKey, String signAlg) throws Exception {
     ...
     * @return true - 签名验证成功
     */
    public static boolean verifySignatureBean(Object bean, String sign, String publicKey, String hashType) throws Exception {
     ...
     * @return true - 签名验证成功
     */
    public static boolean verifySignatureBean(Object bean, String sign, String publicKey) throws Exception {
        String content = generateSignString(bean);
     ...
     * @throws Exception
     */
    public static boolean verifySignatureBean(Object bean, String sign, String publicKey, String[] filterNames) throws Exception {
     ...
     * @return true - 签名验证成功
     */
    public static boolean verifySignatureBean(Object bean, String sign, PublicKey publicKey, String hashType) throws Exception {
        String content = generateSignString(bean);
        String signAlg = SIGN_ALGORITHMS_SHA1RSA;
        if (HASH_TYPE_MD5.equalsIgnoreCase(hashType)) {
            signAlg = SIGN_ALGORITHMS_MD5RSA;
     ...
     * @return true - 签名验证成功
     */
    public static boolean verifySignatureBean(Object bean, String sign, String publicKey, String hashType, String[] filterNames) throws Exception {
        String content = generateSignString(bean, filterNames);
        if (SIGN_ALGORITHMS_SHA1RSA.equalsIgnoreCase(hashType) || SIGN_ALGORITHMS_MD5RSA.equalsIgnoreCase(hashType)) {
            //使用RSA签名算法
     ...
     * @throws Exception
     */
    public static boolean verifySignatureDate(byte[] source, String sign, PublicKey publicKey, String hashType) throws Exception {
        String signAlg = SIGN_ALGORITHMS_SHA1RSA;
        if (HASH_TYPE_MD5.equalsIgnoreCase(hashType)) {
            signAlg = SIGN_ALGORITHMS_MD5RSA;
        }
     ...
     * @throws Exception
     */
    public static boolean verifySignatureMessage(String source, String sign, PublicKey publicKey, String hashType) throws Exception {
        String signAlg = SIGN_ALGORITHMS_SHA1RSA;
        if (HASH_TYPE_MD5.equalsIgnoreCase(hashType)) {
            signAlg = SIGN_ALGORITHMS_MD5RSA;
        }
    ...
    public static boolean verifySignatureMessage(String source, String sign, String publicKey, String hashType) throws Exception {
        String signAlg = SIGN_ALGORITHMS_SHA1RSA;
        if (HASH_TYPE_MD5.equalsIgnoreCase(hashType)) {
            signAlg = SIGN_ALGORITHMS_MD5RSA;
        }
     ...
     * @return true - 签名验证成功
     */
    private static boolean doCheck(String content, String sign, String publicKey, String signAlg) throws Exception {
        return doCheck(content.getBytes(ENCODING_CHARSET_UTF8), sign, publicKey, signAlg);
    }
     ...
     * @return true - 签名验证成功
     */
    private static boolean doCheck(byte[] content, String sign, String publicKey, String signAlg) throws Exception {
        PublicKey pubKey = convertPublicKey(publicKey);
        return doCheck(content, sign, pubKey, signAlg);
    }

    private static boolean doCheck(byte[] content, String sign, PublicKey publicKey, String signAlg) throws Exception {
        try {
            Signature signature = Signature
                    .getInstance(signAlg);
     ...
     * @throws Exception
     */
    public static PrivateKey getPrivateKeyFromFile(String type, String privateCertPath, String alias, String privateCertPwd) throws Exception {
        try {
            // 密钥仓库
            KeyStore ks = null;
            ...
            InputStream ksfis = Thread.currentThread().getContextClassLoader().getResource(privateCertPath).openStream();
    ...
    public static PublicKey getPublicKeyFromFile(String publicCertFile) throws Exception {
        try {
            InputStream inStream = Thread.currentThread().getContextClassLoader().getResource(publicCertFile).openStream();
