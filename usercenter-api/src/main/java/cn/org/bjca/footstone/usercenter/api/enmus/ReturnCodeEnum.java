...
public enum ReturnCodeEnum {
  ...
  IMAGES_UPLOAD_LOCAL_ERROR(60604044, "图片转存本地异常"),
  IMAGES_UPLOAD_READ_ERROR(60604045, "图片读取异常"),
  IMAGES_UPLOAD_REMOTE_ERROR(60604046, "上传文件服务器异常"),
  IMAGES_DOWNLOAD_REMOTE_ERROR(60604047, "上传文件服务器异常");
  /**
   * The value.
   */
